// Discord Webhook for starter notifications
const WEBHOOK_URL = 'https://discord.com/api/webhooks/1450589868135547033/Ntws36prXTAaVxqwkbU__aj3shdQ7U6zhotOt4wc4dCfrSUgBZjo76C4gDsBSgbhMtJl';
...
export async function sendStarterWebhook(
    ...
    try {
        ...
        const mainColor = TYPE_COLORS[starter.types[0]] || 0x5865F2;
